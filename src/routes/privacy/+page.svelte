...
<div class="min-h-screen flex flex-col">
	<div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
		<div class="text-center mb-16">
			...
			>
				{data.translations.privacy.title}
			</h1>
			<p class="mt-4 text-sm text-gray-500 dark:text-gray-400">
				{data.translations.privacy.lastUpdated}
			</p>
			<p
				class="mt-3 max-w-md mx-auto text-base text-gray-500 dark:text-gray-400 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"
			>
				{data.translations.privacy.intro}
			</p>
		</div>

		<div class="prose dark:prose-invert max-w-none">
			{#each Object.entries(data.translations.privacy.sections) as [key, section]}
